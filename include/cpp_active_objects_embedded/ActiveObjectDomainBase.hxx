...
#include <cpp_active_objects_embedded/IActiveObjectDomain.hxx>
...
public:
     ...
     * @param active_object
     */
    void RegisterObject(IActiveObject* active_object) final
    {
...
protected:
     ...
     */
    explicit ActiveObjectDomainBase(IEventQueue* queue) : queue_(queue)
    {
    }
